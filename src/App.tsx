...
import { Mail, Phone, Github, Linkedin, Instagram, Facebook, MapPin, Calendar, Code, Database, Briefcase, GraduationCap, Languages, Download, Menu, X, Globe, ExternalLink, Image as ImageIcon, ChevronLeft, ChevronRight, Award, ArrowUp, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function App() {
  ...
  // Active section (nav indicator + scroll progress)
  ...
  useEffect(() => {
    const sectionIds = ['inicio', 'sobre-mi', 'experiencia', 'proyectos', 'habilidades-tecnicas', 'habilidades-blandas', 'contacto'];
  ...
  const navLinkClass = (...sectionIds: string[]) =>
    `relative pb-1 transition-opacity after:content-[''] after:absolute after:left-0 after:-bottom-0.5 after:h-px after:bg-current after:transition-all ${sectionIds.includes(activeSection)
  ...
  return (
    <div className="min-h-screen bg-white text-black dark:bg-black dark:text-white">
      ...
      {/* Scroll progress bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-[2px] bg-black dark:bg-white origin-left z-[110]"
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button
                ...
                className={navLinkClass('sobre-mi')}
              >
                {t.nav.about}
              </button>
              <button
                onClick={() => scrollToSection('experiencia')}
                className={navLinkClass('experiencia')}
              >
                {t.nav.experience}
              </button>
              <button
              ...
              <div className="relative" data-skills-dropdown>
                <button
                  ...
                  className={`${navLinkClass('habilidades-tecnicas', 'habilidades-blandas')} flex items-center gap-1`}
                >
                  {t.nav.skills}
      ...
      {/* Rendered outside <nav>: nav's backdrop-blur creates a containing block that would break this panel's `fixed inset-0` */}
      <AnimatePresence>
        {isMobileMenuOpen && (
            <motion.div
              data-mobile-menu
              ...
              className="md:hidden fixed inset-0 z-[105] bg-white dark:bg-black flex flex-col px-6 pt-4 pb-8"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="p-2 rounded-md border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors"
              ...
              {/* Numbered nav links */}
              <motion.nav
                className="flex-1 flex flex-col justify-center gap-1 py-8 overflow-y-auto"
                initial="closed"
                animate="open"
                variants={{
              ...
              >
                {[
                  { num: '01', id: 'inicio', label: t.nav.home },
                  { num: '02', id: 'sobre-mi', label: t.nav.about },
                  { num: '03', id: 'experiencia', label: t.nav.experience },
                  { num: '04', id: 'proyectos', label: t.nav.projects },
                  { num: '05', id: 'habilidades-tecnicas', label: t.nav.technicalSkills },
                  { num: '06', id: 'habilidades-blandas', label: t.nav.softSkills },
                  { num: '07', id: 'contacto', label: t.nav.contact },
                ].map((item) => (
                  <motion.button
                    key={item.id}
                    variants={{
                    ...
                    className={`flex items-baseline gap-4 py-3 border-b border-gray-200 dark:border-gray-800 text-left transition-opacity ${activeSection === item.id ? 'opacity-100' : 'opacity-50'
                      }`}
                  >
                    <span className="text-xs font-mono opacity-60">{item.num}</span>
                    <span className="text-3xl font-bold tracking-tight">{item.label}</span>
                  </motion.button>
                ))}
              </motion.nav>

              {/* Footer: CV, idioma, tema */}
              <div className="border-t border-gray-200 dark:border-gray-800 pt-6 space-y-6">
                <a
                  href="/Edgar Josue Espinoza Zambrano CV.pdf"
                  download
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-full font-semibold bg-black text-white dark:bg-white dark:text-black"
                >
                  <Download className="w-4 h-4" />
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 w-full min-h-0 md:h-full md:flex md:items-center" style={{ overflowX: 'hidden', minHeight: '600px' }}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative w-full">
            ...
            <div className="flex justify-center md:order-2 order-1 px-4 sm:px-8 md:px-4 py-12 md:py-8 relative overflow-hidden" style={{ minHeight: '450px' }}>
              ...
              >
                {/* Tech circuit rings - monocromo */}
                <motion.div
                  className="absolute inset-0 -m-2 sm:-m-4 rounded-full border-2 border-black/20 dark:border-white/20"
                  animate={{
                    rotate: 360,
                    scale: [1, 1.1, 1],
                  }}
                ...
                />
                <motion.div
                  className="absolute inset-0 -m-4 sm:-m-8 rounded-full border border-black/10 dark:border-white/10"
                  animate={{
                    rotate: -360,
                    scale: [1.1, 1, 1.1],
                  }}
                ...
                {/* Tech particles floating - monocromo */}
                <motion.div
                  className="absolute -top-2 -right-2 w-3 h-3 rounded-full bg-black dark:bg-white"
                  animate={{
                    y: [-5, -15, -5],
                    x: [0, 5, 0],
                    scale: [0.8, 1.2, 0.8],
                ...
                />
                <motion.div
                  className="absolute -bottom-4 -left-4 w-2 h-2 rounded-full bg-gray-400 dark:bg-gray-500"
                  animate={{
                    y: [0, -10, 0],
                    x: [0, -3, 0],
                    scale: [1, 0.5, 1],
                ...
                <motion.div
                  className={`absolute -top-4 md:-top-6 left-1/4 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                ...
                <motion.div
                  className={`absolute -top-2 md:-top-4 right-1/4 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    y: [0, -10, -20, -25],
                ...
                <motion.div
                  className={`absolute top-1/4 left-0 sm:-left-8 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    x: [0, -10, -15, -20],
                ...
                <motion.div
                  className={`absolute top-1/3 right-0 sm:-right-8 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    x: [0, 10, 15, 20],
                ...
                <motion.div
                  className={`absolute bottom-1/4 left-0 sm:-left-8 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    x: [-5, -15, -20, -25],
                ...
                <motion.div
                  className={`absolute bottom-1/3 right-0 sm:-right-8 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    x: [5, 15, 20, 25],
                ...
                <motion.div
                  className={`absolute -bottom-4 md:-bottom-6 left-1/3 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    y: [3, 15, 25, 30],
                ...
                <motion.div
                  className={`absolute -bottom-2 md:-bottom-4 right-1/3 text-xs font-mono font-semibold px-2 py-1 rounded-md z-20 ${isDark ? 'text-white bg-gray-900/80' : 'text-gray-900 bg-white/80'
                    } backdrop-blur-sm border ${isDark ? 'border-gray-700' : 'border-gray-300'}`}
                  animate={{
                    opacity: [0, 1, 1, 0],
                    y: [0, 10, 20, 25],
                ...
                <motion.div
                  className="absolute -top-4 md:-top-8 right-1/6 text-xs font-mono z-20 text-black/50 dark:text-white/50"
                  animate={{
                    opacity: [0, 1, 0],
                    y: [-3, -8, -12],
                  }}
                ...
                <picture>
                  <source srcSet="/imagen-cv.webp" type="image/webp" />
                  <motion.img
                    src="/imagen-cv.png"
                    ...
                    whileHover={{
                      ...
                      rotateX: 5,
                      filter: isDark
                        ? 'drop-shadow(0 0 40px rgba(255, 255, 255, 0.5)) brightness(1.1)'
                        : 'drop-shadow(0 0 40px rgba(0, 0, 0, 0.3)) brightness(1.05)',
                    }}
                    transition={{
                      type: "spring",
                      stiffness: 300,
                ...
                >
                  ...
                  <motion.div
                    className="absolute text-2xl text-black dark:text-white"
                  ...
                  <motion.div
                    className="absolute text-2xl text-gray-700 dark:text-gray-300"
                    initial={{ x: 0, y: 0, opacity: 0 }}
                    whileHover={{
                      x: 35,
                      y: -25,
                  ...
                  <motion.div
                    className="absolute text-xl text-black dark:text-white"
                    initial={{ x: 0, y: 0, opacity: 0 }}
                    whileHover={{
                      x: -25,
                      y: 45,
                  ...
                  <motion.div
                    className="absolute text-xl text-gray-700 dark:text-gray-300"
                    initial={{ x: 0, y: 0, opacity: 0 }}
                    whileHover={{
                      x: 35,
                      y: 40,
                  ...
                  <motion.div
                    className="absolute text-lg text-black dark:text-white"
                    initial={{ x: 0, y: 0, opacity: 0 }}
                    whileHover={{
                      x: 0,
                      y: -50,
                  ...
                  <motion.div
                    className="absolute text-lg text-gray-700 dark:text-gray-300"
                    initial={{ x: 0, y: 0, opacity: 0 }}
                    whileHover={{
                      x: -35,
                      y: 0,
                ...
                {/* Glowing border - monocromo */}
                <motion.div
                  className="absolute inset-0 rounded-full border-2 border-transparent z-5"
                  whileHover={{
                    borderColor: isDark
                      ? ["rgba(255, 255, 255, 0)", "rgba(255, 255, 255, 0.7)", "rgba(255, 255, 255, 0.4)", "rgba(255, 255, 255, 0)"]
                      : ["rgba(0, 0, 0, 0)", "rgba(0, 0, 0, 0.6)", "rgba(0, 0, 0, 0.3)", "rgba(0, 0, 0, 0)"],
                    scale: [1, 1.1, 1.08, 1.05, 1.02],
                    boxShadow: isDark
                      ? ["0 0 0 rgba(255, 255, 255, 0)", "0 0 30px rgba(255, 255, 255, 0.35)", "0 0 40px rgba(255, 255, 255, 0.2)"]
                      : ["0 0 0 rgba(0, 0, 0, 0)", "0 0 25px rgba(0, 0, 0, 0.25)", "0 0 35px rgba(0, 0, 0, 0.15)"]
                  }}
                  transition={{
                ...
                {/* Soft glow background on hover - monocromo */}
                <motion.div
                  className="absolute inset-0 -m-4 sm:-m-8 rounded-full z-0 bg-black/5 dark:bg-white/5"
                  ...
                  whileHover={{
                    ...
                    background: isDark
                      ...
                      : "radial-gradient(circle, rgba(0, 0, 0, 0.06) 0%, transparent 100%)"
                  }}
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-xs tracking-[0.3em] uppercase opacity-50 text-center mb-3">01 — {t.about.title}</p>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-xs tracking-[0.3em] uppercase opacity-50 text-center mb-3">02 — Experiencia</p>
          <h2 className="text-4xl font-bold text-center mb-16">
            Experiencia Laboral
          </h2>
          <div className="space-y-8">
            ...
            <div className="p-8 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                <div>
                  <h3 className="text-xl font-semibold">Desarrollador Backend</h3>
                  <p className="opacity-80">Cherry – Sistema de Gestión de Compras </p>
                </div>
                <div className="flex items-center gap-2 opacity-70">
                  <Calendar className="w-4 h-4" />
                  <span>03/2026 – 08/2026</span>
                </div>
              </div>
              <ul className="opacity-90 space-y-2 mb-4">
                <li>• Desarrollo integral del backend de la plataforma utilizando Node.js y Express.</li>
                <li>• Diseño e implementación de APIs REST para la comunicación entre los diferentes componentes del sistema. </li>
                <li>• Diseño y gestión de la base de datos, incluyendo consultas y operaciones de persistencia.</li>
                <li>• Desarrollo de servicios y lógica de negocio para las principales funcionalidades de la plataforma.</li>
                <li>• Integración backend-frontend y configuración de los servicios del sistema. </li>
              </ul>

              <a
                href="https://cherrycompraconmigo.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block px-4 py-2 rounded-md bg-black text-white dark:bg-white dark:text-black hover:opacity-80 transition"
              >
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-xs tracking-[0.3em] uppercase opacity-50 text-center mb-3">03 — Proyectos</p>
          <h2 className="text-4xl font-bold text-center mb-16">
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-xs tracking-[0.3em] uppercase opacity-50 text-center mb-3">04 — Habilidades</p>
          <h2 className="text-4xl font-bold text-center mb-16">
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-xs tracking-[0.3em] uppercase opacity-50 text-center mb-3">05 — {t.softSkills.title}</p>
          <h2 className="text-4xl font-bold text-center mb-16">
            {t.softSkills.title}
          </h2>
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.3em] uppercase opacity-50 mb-3">06 — {t.certificates.title}</p>
      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          <p className="text-xs tracking-[0.3em] uppercase opacity-50 text-center mb-3">07 — {t.contact.title}</p>
          <h2 className="text-4xl font-bold text-center mb-16">
            {t.contact.title}
          </h2>
            ...
            <div>
              ...
              <div className="mb-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-6 py-3 border border-black dark:border-white rounded-full font-semibold hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {submitStatus === 'success' && (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-4 border border-black dark:border-white bg-gray-50 dark:bg-gray-900 rounded-lg"
                  >
                ...
                {submitStatus === 'error' && (
                  ...
                  >
                    ...
                    <span>Error al enviar el mensaje. Por favor, intenta de nuevo o contáctame directamente por email.</span>
                  </motion.div>
                )}
              </form>
            </div>
